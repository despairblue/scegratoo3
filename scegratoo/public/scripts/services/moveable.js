...
window.angular.module('scegratooApp')
  .service('Moveable', function (x3dom) {
    ...
    */
    const Moveable = function (x3domElem, boundedObj, callback, gridSize, mode) {
    ...
    Moveable.prototype.setGridSize = function (gridSize) {
      this._gridSize = gridSize
    }

    // interaction mode setter, for translation and/or rotation
    Moveable.prototype.setMode = function (mode) {
    ...
    Moveable.prototype.detachHandlers = function () {
    ...
    Moveable.prototype.rotate = function (posX, posY) {
      var twoPi = 2 * Math.PI
